...
class SequentialLabelingTask(BaseTask):
    ...
    def load_datasets(self):
        self.train_dataset = PhoNer(self.train_path, self.vocab)
        self.val_dataset = PhoNer(self.val_path, self.vocab)
        self.test_dataset = PhoNer(self.test_path, self.vocab)
