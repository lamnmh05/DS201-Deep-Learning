...
from src.data.UIT_ViOCD import UIT_ViOCD_Domain
from src.models.transformer import TransformerForClassification
...
class TextClassificationTask(BaseTask):
    ...
    def load_datasets(self):
        self.train_dataset = UIT_ViOCD_Domain(self.train_path, self.vocab)
        self.val_dataset = UIT_ViOCD_Domain(self.val_path, self.vocab)
        self.test_dataset = UIT_ViOCD_Domain(self.test_path, self.vocab)
